...
import org.thor.base.view.dialog.listener.OnOperItemClickL;
import org.thor.base.view.dialog.utils.CornerUtils;
...
public class ActionSheetDialog extends BottomBaseDialog<ActionSheetDialog> {
     ...
     */
        mVLineTitle.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, dp2px(0.8f)));
     ...
     */
        mTvCancel.setTextSize(TypedValue.COMPLEX_UNIT_SP, 17.5f);
        ...
        mLv.setDividerHeight(dp2px(0.8f));
    ...
    private class DialogMenuItem {
        ...
        DialogMenuItem(String operName, int resId) {
            mOperName = operName;
            mResId = resId;
        }
    }
